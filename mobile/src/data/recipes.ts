...
export const RECIPES: RecipesData = {
  ...
  recipes: [
    ...
    },
    {
      ...
      summary: 'On-sale avocado and crunchy radishes on toasted baguette or rolls.',
      servings: 2,
      timeMinutes: 10,
      tags: ['vegan', 'american', 'lunch'],
      ingredients: [
        { label: 'Baguette or rolls', keywords: ['baguette', 'brötchen'], qty: '4 slices', exclude: ['donut', 'croissant', 'gebäck'] },
    ...
    },
    {
      ...
      ingredients: [
        ...
        { label: 'Cucumber', keywords: ['gurke'], qty: '1', exclude: ['leber', 'gurkenleber'] },
    ...
    {
      id: 'tomato-garlic-spaghetti',
      title: 'Tomato & Garlic Spaghetti',
      summary: 'A weeknight pasta from on-sale Roma tomatoes, garlic and spaghetti.',
      servings: 2,
      timeMinutes: 20,
      tags: ['vegan', 'italian', 'dinner'],
      ingredients: [
        { label: 'Spaghetti', keywords: ['spaghetti'], qty: '250 g', staple: true },
        { label: 'Roma tomatoes', keywords: ['tomate'], qty: '500 g', exclude: ['käse', 'ketchup', 'mark', 'getrocknet'] },
      ...
      steps: [
        ...
        'Gently fry the sliced garlic and spring onions in olive oil; add the chopped tomatoes and simmer 8 min.',
        'Toss the drained pasta through the sauce, season and serve.',
      ],
    },
    {
      id: 'chicken-noodle-stirfry',
      title: 'Chicken & Kohlrabi Noodle Stir-fry',
      summary: 'On-sale chicken and kohlrabi tossed through quick noodles.',
      servings: 2,
      timeMinutes: 25,
      tags: ['meat', 'asian', 'dinner'],
      ingredients: [
        { label: 'Chicken', keywords: ['hähnchen'], qty: '300 g', exclude: ['döner', 'wurst', 'aufschnitt', 'pastete', 'steaktasche', 'grillies', 'nuggets', 'pelmeni'] },
        { label: 'Egg noodles', keywords: ['nudeln', 'mie'], qty: '200 g' },
      ...
      steps: [
        ...
        'Stir-fry the sliced chicken in hot oil until golden; add julienned kohlrabi and garlic.',
        'Toss in the noodles, spring onions and soy sauce; fry 2 min more and serve.',
      ],
    },
    {
      ...
      ingredients: [
        { label: 'Salmon fillet', keywords: ['lachsfilet'], qty: '2 fillets', exclude: ['seelachs', 'garnele', 'schinken', 'aufschnitt', 'vegan'] },
        { label: 'Cucumber', keywords: ['gurke'], qty: '1', exclude: ['leber', 'gurkenleber'] },
    ...
    },
    {
      ...
      ingredients: [
        ...
        { label: 'Cucumber', keywords: ['gurke'], qty: '1/2', exclude: ['leber', 'gurkenleber'] },
        { label: 'Dill', keywords: ['dill'], qty: '2 tbsp', staple: true },
    ...
    },
    {
      ...
      ingredients: [
        ...
        { label: 'Pickled cucumber', keywords: ['gurke'], qty: '1', exclude: ['leber', 'gurkenleber'] },
    ...
    },
    {
      ...
      ingredients: [
        ...
        { label: 'Rolls', keywords: ['brötchen', 'baguette'], qty: '2', exclude: ['donut', 'croissant', 'gebäck'] },
        { label: 'Lettuce', keywords: ['romana', 'eisberg', 'salat'], qty: '4 leaves', exclude: ['dressing', 'fix für'] },
