...
Use [GitHub's private vulnerability reporting](https://github.com/Ali0600/grocery-helper/security/advisories/new),
...
Only the current `main` branch is supported. This is a public API and a mobile app; fixes land on
